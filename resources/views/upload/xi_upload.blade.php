...
<div class="row justify-content-center m-2">
  <div class="col-md-12 ">
    <div class="card">
      <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">XI Upload</li>
        </ol>
      </nav>
      <div class="card-body">
        <div class="row" >
    ...
    <form action="/xi_upload" method="POST" enctype="multipart/form-data"> 
        @csrf
              ...
              <div class="col-sm-2 ">
                <div class="btn-group btn-group-inline mt-2">
                  <div class="form-group ">   
                    ...
                    <input type="text" class="form-control" readonly name="standard" value="XI" id="standard">
                  </div>
                </div>
              </div>

...
<script>
            ...
            window.onload = function() {
              ...
              if(x=="MARVEL PUBLICATION" && P=="PHYSICS"){
...
<div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="hidden" name="exam" value="NEET"><input type="hidden"name="standard" value="XI">
                ...
                <table>
                   <tr>
                      <td><label><input type="checkbox" name="chptr[]" value="1. Units & Measurements">1. Units & Measurements...</label></td>
                      <td><label><input type="checkbox" name="chptr[]" value="2. Scalers & Vetors">2. Scalers & Vetors</label></td>
                      <td><label><input type="checkbox" name="chptr[]" value="3. Motion in a straight light">3. Motion in a straight light</label></td>
                      <td><label><input type="checkbox" name="chptr[]" value="4. Motion">4. Motion</label></td> 
                   </tr>
                   <tr>
                      <td><label><input type="checkbox" name="chptr[]" value="1. सर्वात्मका शिवसुंदरा">1. सर्वात्मका शिवसुंदरा</label></td>
                      <td><label><input type="checkbox" name="chptr[]" value="4. Motion">4. Motion</label></td>
                      <td><label><input type="checkbox" name="chptr[]" value="4. Motion">4. Motion</label></td>                      
                      <td><label><input type="checkbox" name="chptr[]" value="4. Motion">4. Motion</label></td> 
                     </tr>
